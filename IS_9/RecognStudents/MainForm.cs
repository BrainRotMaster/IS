...
namespace AForge.WindowsForms
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void UpdateFormFields()
        {
            ...
            statusLabel.Text = $"Распознано: {controller.getCurrentType()}";//////////////////////////////////////////////////////
        }
        ...
        public MainForm(BaseNetwork network, DatasetProcessor datasetProcessor)
        {
            InitializeComponent();
        ...
        {
            controller.SaveBitmap($"..\\..\\dataset/audi");
        }
